...
### 🗺️ 아키텍처 설계도
<img alt="" src="https://github.com/user-attachments/assets/670d55b9-982c-46b6-8efa-3d03d63f2ebd"  width="800">
...
- `fix/(서비스명)...` : (서비스이름) 서비스별 수정되는 작업들을 위한 브랜치입니다.
- `deploy/...` : CI/CD를 위한 브랜치 입니다.
